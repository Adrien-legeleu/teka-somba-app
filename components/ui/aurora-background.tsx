          ...
          style={
            {
              ...
              '--aurora':
                'repeating-linear-gradient(100deg,var(--orange-500)_10%,var(--amber-200)_15%,var(--orange-300)_20%,var(--yellow-200)_25%,var(--orange-400)_30%)',
              '--dark-gradient':
        ...
        >
          <div
            className={cn(
              ...
              [--aurora:repeating-linear-gradient(100deg,var(--orange-500)_10%,var(--amber-200)_15%,var(--orange-300)_20%,var(--yellow-200)_25%,var(--orange-400)_30%)] 
